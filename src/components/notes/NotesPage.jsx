                    ...
                    >
                      <Card.Body>
                        ...
                        <Button
                          ...
                          size='lg'
                          onClick={() => {
                            this.setState({ showDelArchive: true });
                          }}
                        >
                          Delete Archive
                        </Button>
                        <Modal
                          show={this.state.showDelArchive}
                          onHide={() => {
                            this.setState({ showDelArchive: false });
                          }}
  ...
  getAllowedIP = (callback) => {
    axios
      ...
      .then((res) => {
        ...
        const allowed = res ? res.data : false;

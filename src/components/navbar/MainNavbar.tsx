...
function MainNavbar() {
	...
	return (
		<Navbar style={{ backgroundColor: '#222233bb' }} collapseOnSelect fixed="top" expand="md" variant="dark">
			<Container fluid="lg">
				<Navbar.Brand style={{ color: '#60aaf0' }} className="shr-btn" href="home">
				...
				<Navbar.Collapse id="responsive-navbar-nav">
					...
					<Nav className="mr-3">
						...
						<Nav.Link className="shr-btn nav-link m-auto shr-btn" eventKey="contact" href="#/contact/">
